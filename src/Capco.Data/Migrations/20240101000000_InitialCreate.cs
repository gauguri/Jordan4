        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Collection = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Alt = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeLabel = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    ...
                    UPC = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Line1 = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: false),
                    Line2 = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StripePaymentIntentId = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorSnapshot = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    SizeSnapshot = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Qty = table.Column<int>(type: "int", nullable: false),
                    UnitPriceSnapshot = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
